...
<body>
  ...
  <div class="main-content">
    ...
    ?>
      <!-- Header -->
      <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style="min-height: 600px; background-image: url(assets/img/theme/fashion.jpg); background-size: cover; background-position: center top;">
        <!-- Mask -->
              ...
              <form method ="post">
                            ...
                            <div class="pl-lg-4">
                              <div class="row">
                                ...
                                <div class="col-lg-12">
                                  <div class="form-group">
                                    <input type="submit" id="changePassword" name="changePassword" class="btn btn-success form-control-alternative" value="Change Password">
                                  </div>
                                </div>
                              </div>
                            </div>
